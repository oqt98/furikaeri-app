...
export const DEFAULT_TAGS: Record<TagType, TagDefinition[]> = {
  ...
  state: [
    ...
    { id: 'state-healthy', label: '体調よい', type: 'state' },
    { id: 'state-headache', label: '体調いまいち', type: 'state' },
    { id: 'state-rainy', label: '天気が悪い', type: 'state' },
    { id: 'state-relaxed', label: '気持ちに余裕', type: 'state' },
    { id: 'state-stress', label: 'ストレス高め', type: 'state' },
